...
import dls_web_image from '../../assets/dls_web_image.jpg';
import im1 from '../../assets/im1.jpg';
import placeholder_interactive_systems from '../../assets/placeholder_interactive_systems.jpg';
import plchldr_computational_semantics from '../../assets/plchldr_computational_semantics.jpg';
    ...
    return (
      <div class="Projects-container">
        ...
        <div class="buttonContainer">
          ...
          <button
            className="button"
            onclick={() => this.selectFilterCategory("computational-semantics")}
          >
            {" "}
        ...
        <div className="row">
          <div id="reading-projects" className="column">
            <div className="content">
              <img src={im1} alt="CARLA" style={{ width: "100%" }} />
              <h4>CARLA</h4>
              <p>
          ...
          <div id="reading-projects" className="column">
            <div className="content">
              <img src={im1} alt="CARTI" style={{ width: "100%" }} />
              <h4>CARTI</h4>
              <p>
          ...
          <div id="reading-projects" className="column">
            <div className="content">
              <img src={im1} alt="Early-ICARE" style={{ width: "100%" }} />
              <h4>Early-ICARE</h4>
              <p>
          ...
          <div id="reading-projects" className="column">
            <div className="content">
              <img src={im1} alt="ICARE" style={{ width: "100%" }} />
              <h4>ICARE</h4>
              <p>
          ...
          <div id="interactive-systems" className="column">
            <div className="content">
              <img
                src={placeholder_interactive_systems}
          ...
          <div id="computational-semantics" className="column">
            <div className="content">
              <img
                src={plchldr_computational_semantics}
                alt="ICARE"
                style={{ width: "100%" }}
              />
              <h4>PropBank</h4>
